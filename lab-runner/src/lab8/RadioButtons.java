...
public class RadioButtons extends JPanel {
    ...
    private ImageIcon selected, notSelected, hovered, pressed, rolledAndSelected;
    ...
    private void loadIcons() {
        ...
        rolledAndSelected = transformIcon(new ImageIcon(PATH_TO_ICONS + "5.jpg"));
    }
    ...
    private void setupRadioButton(JRadioButton rb) {
        ...
        rb.setRolloverSelectedIcon(rolledAndSelected);
    }
}
